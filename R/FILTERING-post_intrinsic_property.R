...
#' @export
post_intrinsic_property <- function(property, formula = NULL, 
                                    complexity = "any", isotopic = "any", 
                                    mass = NULL, range = NULL, 
                                    order_by = "recordId", 
  ...
  if (tolower(property) != "formula" && is.null(mass) || 
      tolower(property) != "formula" && is.null(range)) {
  ...
  if (any(tolower(property) %in% c("molecularweight", "nominalmass", 
  ...
  if (tolower(property) == "formula") {
    ...
    data <- list("formula" = formula, "options" = options, 
  ...
  if (tolower(property) == "molecularweight") {
    ...
    molecular_weight <- list("mass" = mass, "range" = range)
    
    data <- list("molecularWeight" = molecular_weight, "options" = options,
                 "orderBy" = order_by, "orderDirection" = order_direction)
  ...
  if (tolower(property) == "nominalmass") {
    ...
    nominal_mass <- list("mass" = mass, "range" = range)
    
    data <- list("nominalMass" = nominal_mass, "options" = options, 
                 "orderBy" = order_by, "orderDirection" = order_direction)
  ...
  if (tolower(property) == "averagemass") {
    ...
    average_mass <- list("mass" = mass, "range" = range)
    
    data <- list("averageMass" = average_mass, "options" = options, 
                 "orderBy" = order_by, "orderDirection" = order_direction)
  ...
  if (tolower(property) == "monoisotopicmass") {
    ...
    monoisotopic_mass <- list("mass" = mass, "range" = range)
    
    data <- list("monoisotopicMass" = monoisotopic_mass, "options" = options, 
                 "orderBy" = order_by, "orderDirection" = order_direction)

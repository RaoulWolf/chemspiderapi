...
<!-- badges: start -->
[![R build status](https://github.com/RaoulWolf/chemspiderapi/workflows/R-CMD-check/badge.svg)](https://github.com/RaoulWolf/chemspiderapi/actions)
...
To handle PNG images, the [`{magick}`](https://cran.r-project.org/package=magick) and [`{png}`](https://cran.r-project.org/package=png) packages are recommended.
...
As of `r Sys.Date()`, the following functionalities are implemented and fully annotated (`r signif((27 / 27) * 100, digits = 2)`%):
...
* **Saving PNG Images**: Examples on how to save PNG files, as returned by `get_record_id_image()`, using functionalities of the `magick` package.

## Funding

This package was originally created at the [Norwegian Institute for Water Research (NIVA)](https://www.niva.no/en) at NIVA's [Section for Ecotoxicology and Risk Assessment](https://www.niva.no/en/research/ecotoxicology_and_risk_assessment) and funded by [the Research Council of Norway (RCN)](https://www.forskningsradet.no/en/), project 268294: [Cumulative Hazard and Risk Assessment of Complex Mixtures and Multiple Stressors (MixRisk)](https://www.forskningsradet.no/prosjektbanken/#/project/NFR/268294/Sprak=en).

...
test_that("fails if NULL is provided as API key.", {
  ...
  expect_error(
    get_formula_batch_query_id_status(
      query_id = "0c98889f-5e8b-4974-aabb-31ab28c54261", apikey = NULL)
  )
...
test_that("fails if a numeric API key is provided.", {
  ...
  expect_error(
    get_formula_batch_query_id_status(
      query_id = "0c98889f-5e8b-4974-aabb-31ab28c54261", apikey = 1234567890)
  )
...
test_that("fails if a logical API key is provided.", {
  ...
  expect_error(
    get_formula_batch_query_id_status(
      query_id = "0c98889f-5e8b-4974-aabb-31ab28c54261", apikey = TRUE)
  )

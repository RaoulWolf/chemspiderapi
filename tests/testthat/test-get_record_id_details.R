...
test_that("get_record_id_details() returns an NA vector if record ID is wrong", {
  expect_error(
...
test_that("get_record_id_details() returns an NA vector if apikey is wrong", {
  expect_error(
    get_record_id_details(record_id = 2157L, 
                         apikey = "A wrong apikey")
    )
})

test_that("get_record_id_details() fails if coerce is wrong.", {
  expect_error(
    get_record_id_details(record_id = 2157L, 
...
#   expect_type(
#     get_record_id_details(record_id = 2424L,
